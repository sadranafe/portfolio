    ...
    return (
        <>
            <div className = "h-screen w-full text-center flex flex-col justify-center items-center gap-5">
                ...
                <div>
                    <h1 className = "hero-title font-display font-extrabold text-8xl">sadra <br/> nafe</h1>
                </div>
                ...
                <div className = "mt-2 flex max-[300px]:flex-wrap justify-center items-center gap-4">
                    <Link href = '#work' className = "capitalize rounded-lg py-2.5 px-3 bg-sky-500 dark:bg-sky-600 text-white">view work</Link>
