        ...
        <>
            <div className = "h-screen w-full text-center flex flex-col justify-center items-center gap-5">
                <div className = "flex justify-center items-center gap-2">
                    ...
                    <p className = "uppercase text-sky-600 font-semibold tracking-widest">open to work · tehran, iran</p>
                </div>

                <div>
                    <h1 className = "font-display font-extrabold text-8xl">sadra <br/> nafe</h1>
                </div>
                
                <div className = "w-20 h-0.5 rounded-full bg-sky-500"></div>

                <div className = "mt-5">
                    <Link href = '#work' className = "capitalize rounded-lg py-2.5 px-3 bg-sky-500 dark:bg-sky-600 text-white mr-5">view work</Link>
